        ...
        switch (selectedRole) {
            case "Admin" -> {
                ...
                if (admin != null && admin.getPassword().equals(pass)) {
                    AdminDashboardController ctrl =
                            MainApp.loadScreenWithController("admin-dashboard");
            ...
            case "Teacher" -> {
                ...
                if (teacher != null && teacher.getPassword().equals(pass)) {
                    TeacherDashboardController ctrl =
                            MainApp.loadScreenWithController("teacher-dashboard");
            ...
            case "Student" -> {
                ...
                if (student != null && student.getPassword().equals(pass)) {
                    StudentDashboardController ctrl =
                            MainApp.loadScreenWithController("student-dashboard");
